...
public class SVO {
	...
	private String store_name, store_sub, store_img, store_hashtag, store_location, store_hour, store_menu;
	private int store_idx, store_like, store_comment, store_view;
	private MultipartFile file;
	
	public SVO() { }
	
	public SVO(String store_name, String store_sub, String store_img, String store_hashtag, String store_location,
			String store_hour, String store_menu, int store_idx, int store_like, int store_comment, int store_view,
			MultipartFile file) {
		super();
